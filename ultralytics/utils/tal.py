...
class TaskAlignedAssigner(nn.Module):
    ...
    def get_pos_mask(self, pd_scores, pd_bboxes, gt_labels, gt_bboxes, anc_points, mask_gt):
        ...
        mask_in_gts = self.select_candidates_in_gts(anc_points, gt_bbox, mask_gt)
        # Get anchor_align metric, (b, max_num_obj, h*w)
        align_metric, overlaps = self.get_box_metrics(pd_scores, pd_bboxes, gt_labels, gt_bbox, mask_in_gts * mask_gt)
