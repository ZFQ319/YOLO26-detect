...
class Explorer:
    ...
    def query(
        ...
        Returns:
            (pyarrow.Table): An arrow table containing the results. Supports converting to:
                - pandas dataframe: `Grad_CAM_result.to_pandas()`
                - dict of lists: `Grad_CAM_result.to_pydict()`
    ...
    def sql_query(
        ...
        Args:
            ...
            return_type (str): Type of the Grad_CAM_result to return. Can be either 'pandas' or 'arrow'. Defaults to 'pandas'.
        ...
        Example:
            ...
            Grad_CAM_result = exp.sql_query(query)
            ```
        """
    ...
    def plot_sql_query(self, query: str, labels: bool = True) -> Image.Image:
        ...
        Example:
            ...
            exp.create_embeddings_table()
            query = "SELECT * FROM 'table' WHERE labels LIKE '%person%'"
            Grad_CAM_result = exp.plot_sql_query(query)
            ```
        """
